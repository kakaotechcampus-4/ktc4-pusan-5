import { Card, Empty, ErrorBox, SkeletonText } from '@/components/ui';
...
/**
 * "AI 보고서" 탭의 내용물. 제목·탭은 부모(StockInsightSection)가 갖고 있어 여기선 카드 내용만 그린다.
...
export function AiReportSection({
  ...
  return (
    <Card tone="plain">
      ...
      {status === 'empty' && (
        <Empty title="아직 보고서가 준비되지 않았습니다" description="잠시 후 다시 확인해주세요" />
      )}
        ...
        <>
          ...
          {report.targetPrice && (
            <p className="text-sm text-neutral-700">
              ...
              <span className="text-xs text-neutral-600">(출처: {report.targetPrice.source})</span>
            </p>
          )}
